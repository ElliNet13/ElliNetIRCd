...
class TestTour(AsyncTestCase, TestIRC):
     ...
     async def atest_tour(self, nursery) -> None:
        ...
        self.assertEqual(await bob.urecv(), ":ip6-localhost CAP * LS :away-notify cap-notify multi-prefix chghost echo-message\r\n")
        ...
        self.assertEqual(await bob.urecv(), textwrap.dedent(f"""\
            ...
            :ip6-localhost 004 bob ellinetircd {ellinetircd.__version__} {"".join(usermodes)} \r
